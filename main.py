...
def initGround():
    ...
    ground1 = sprites.create(img("""
        ...
        """),
        SpriteKind.ground)
    ground1.set_position(scene.screen_width() / 2, 100)

def on_a_pressed():
    animation.run_image_animation(ninja, assets.animation("""
        myAnim0
    """), 50, False)
...
controller.move_sprite(ninja, 70, 70)
ninja.set_stay_in_screen(True)
